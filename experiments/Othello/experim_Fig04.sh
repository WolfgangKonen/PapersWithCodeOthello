...
# Computation times: 
#	 - training   takes about 40h, if run on a standalone standard CPU (2h for each H010 agent). 
#	   For parallel training runs on different cores see experim_Fig04_parallel.sh.
...
java -ea -Xmx12096M -jar jartools/GBGBatch.jar Othello 5 TCL4-100_7_250k-lam05_P4_H010-FAm-stub.agt.zip 20 250000 $train_out_dir
