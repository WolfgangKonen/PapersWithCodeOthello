...
# Computation times: 
#	 - training   takes about 9d, if run on 10 parallel cores (4.5d for each W100 agent, 2 agents per core). 
...
nohup java -ea -Xmx12096M -jar jartools/GBGBatch.jar Othello 5 TCL4-100_7_250k-lam05_P4_H010-FAm-W100-EX0-stub.agt.zip 2 250000 $train_out_dir &
nohup java -ea -Xmx12096M -jar jartools/GBGBatch.jar Othello 5 TCL4-100_7_250k-lam05_P4_H010-FAm-W100-EX0-stub.agt.zip 2 250000 $train_out_dir &
nohup java -ea -Xmx12096M -jar jartools/GBGBatch.jar Othello 5 TCL4-100_7_250k-lam05_P4_H010-FAm-W100-EX0-stub.agt.zip 2 250000 $train_out_dir &
nohup java -ea -Xmx12096M -jar jartools/GBGBatch.jar Othello 5 TCL4-100_7_250k-lam05_P4_H010-FAm-W100-EX0-stub.agt.zip 2 250000 $train_out_dir &
nohup java -ea -Xmx12096M -jar jartools/GBGBatch.jar Othello 5 TCL4-100_7_250k-lam05_P4_H010-FAm-W100-EX0-stub.agt.zip 2 250000 $train_out_dir &
